...
info ""
info "  build & unit tests, commit-hygiene, docs, coverage   (all three rungs)"
info "  ladder                                               (staging and main)"
info ""
info "Do not require 'integration tests'. That job is a no-network stub without"
info "operator TRADOVATE_* credentials; this tree has no fake gateway."
info ""
