...
The contract governing CI/CD, packaging, and the release path is
**[`documentation/agents/platform.md`](../../documentation/agents/platform.md)**. Read it before changing
anything here or in the release workflow — it is role-scoped and owns those wherever they live.
