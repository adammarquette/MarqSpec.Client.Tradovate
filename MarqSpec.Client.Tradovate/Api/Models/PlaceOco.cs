...
/// <summary>
/// A Tradovate <c>/order/placeoco</c> request (one-cancels-other).
/// </summary>
public sealed record PlaceOco
{
    ...
    /// <summary>Gets the first-leg action.</summary>
    ...
    /// <summary>Gets the first-leg order type.</summary>
    ...
    /// <summary>Gets the other OCO leg.</summary>
    public required RestrainedOrderVersion Other { get; init; }
}
