...
/// <summary>
/// A Tradovate <c>/order/placeorder</c> request.
/// </summary>
public sealed record PlaceOrder
{
    ...
    /// <summary>Gets the contract symbol (e.g. <c>ESM24</c>).</summary>
    ...
    /// <summary>Gets a value indicating whether the order is automated. Automated callers should set this <see langword="true"/>.</summary>
